...
public class RPSLSpock {
    ...
    /**
     * Boolean method that determines whether human pick is valid or not
     * @param pick
     * @return
     */
    ...
    /**
     * Method that generates computer pick randomly.
     * @return pick
     */
    ...
    /**
     * Method that determines which pick wins, between the computer and human pick
     * @param c_pick
     * @param h_pick
     * @return
     */
