...
/**
 * Main class to run the rock, paper, scissors, lizard and spock program
 * @author Mohamed Ali
 */
...
public class Main {
    ...
    /**
     *Main method to test if human wins or computer wins and determine if user wants to continue with game.
     * @param args
     */
